...
import "../token/TokenNFT.sol";
import "../registry/IAssetRegistry.sol";
import "../libraries/UniversalAssetLib.sol";

/**
 * @title TokenFactory
 * @notice Factory contract for deploying ERC-20 or ERC-721 compliant security tokens
 * @dev Allows users to choose their preferred token standard for RWA tokenization
    ...
    UUPSUpgradeable
{
    ...
    // Implementation addresses for beacon pattern
    ...
    function initialize(
        ...
        erc20Implementation = address(new Token());
        erc721Implementation = address(new TokenNFT());
    }
