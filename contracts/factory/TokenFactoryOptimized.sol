...
/**
 * @title TokenFactoryOptimized
 * @notice Optimized factory contract for deploying ERC-20 or ERC-721 compliant security tokens
 * @dev Uses external implementation addresses instead of deploying them
 * @custom:security-contact security@finatrades.com
 */
contract TokenFactoryOptimized is 
    Initializable,
    ...
    UUPSUpgradeable
{
    ...
    function _deployERC721Token(
        ...
        // Encode initialization data for TokenNFT contract
        bytes memory initData = abi.encodeWithSignature(
