...
async function main() {
    console.log("🚀 Continuing Polygon Mainnet Deployment...\n");
    ...
    try {
        ...
        const setClaimTx = await identityRegistry.setClaimTopicsRegistry(deployment.contracts.ClaimTopicsRegistry);
